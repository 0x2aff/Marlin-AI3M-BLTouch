 ...
 */
   ...
   */
  #define DETAILED_BUILD_VERSION SHORT_BUILD_VERSION " (Github, exceptionptr)"
   ...
   * version was tagged.
   */
  #define STRING_DISTRIBUTION_DATE "2020-02-01"
   ...
   * Marlin repository.
   */
  #define SOURCE_CODE_URL "https://github.com/0x2aff/Marlin-AI3M-BLTouch"
